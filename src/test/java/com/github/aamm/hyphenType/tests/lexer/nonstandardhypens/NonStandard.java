 ...
 */
package com.github.aamm.hyphenType.tests.lexer.nonstandardhypens;
 ...
 */
@ArgumentsObject(doubleHyphenInLongOptions = true, singleHyphen = "@@@@", doubleHyphen = "###", equals = ":=")
public interface NonStandard extends Options<CanonicalExitCode> {
