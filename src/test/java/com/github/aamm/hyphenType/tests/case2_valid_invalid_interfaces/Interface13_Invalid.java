 ...
 */
@ArgumentsObject
public interface Interface13_Invalid extends Options<CanonicalExitCode> {

    @Option
    boolean x();

    @OptionArgument(index = 0, option = "x", mandatory = false, channels = {
	    InputChannel.ARGUMENT, InputChannel.GUI })
    String x1();
}
