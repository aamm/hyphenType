 ...
 */
@ArgumentsObject
public interface Interface08_Invalid extends Options<CanonicalExitCode> {

    @Option
    boolean x();

    @OptionArgument(index = 0, option = "x", mandatory = false)
    String a();

    @OptionArgument(index = 1, option = "x", mandatory = true)
    String b();
}
