 ...
 */
@ArgumentsObject
public interface Interface11_Invalid extends Options<CanonicalExitCode> {
    ...
    @OptionArgument(index = 1, option = "x", mandatory = true, channels = InputChannel.GUI)
    String x2();

    @OptionArgument(index = 2, option = "x", mandatory = true, channels = InputChannel.ARGUMENT)
    String x3();
}
